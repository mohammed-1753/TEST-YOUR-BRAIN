...
<title>Project Worlds || TEST YOUR BRAIN </title>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your college/school name" class="form-control input-md" type="text">
